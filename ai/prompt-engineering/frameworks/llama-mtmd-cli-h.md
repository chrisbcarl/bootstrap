...
--ignore-eos                            ignore end of stream token and continue generating (implies
                                        --logit-bias EOS-inf)
--temp, --temperature N                 temperature (default: 0.20)
...
Usage: C:\Users\chris\AppData\Local\Microsoft\WinGet\Packages\ggml.llamacpp_Microsoft.Winget.Source_8wekyb3d8bbwe\llama-mtmd-cli.exe [options] -m <model> --mmproj <mmproj> --image <image> --audio <audio> -p <prompt>
