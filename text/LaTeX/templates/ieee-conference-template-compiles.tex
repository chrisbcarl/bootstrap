...
\lipsum[10] % filler text (without this, the actual content of the document doesn't justify sticking the table in the middle of it, so it doesn't...)
...
\lipsum[10-22] % more filler text (without this, the actual content of the document doesn't justify sticking the table in the middle of it, so it doesn't...)
...
\subsection{Single column table}
...
% % https://tex.stackexchange.com/a/536527
\begin{table}
\small
...
Insert figures and tables after they are cited in the text. Use the abbreviation, even at the beginning of a sentence.



\begin{figure}[htbp]
\caption{Example of a figure caption.}
\centerline{fig1.png was here}
\label{fig}
\end{figure}
