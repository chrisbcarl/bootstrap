...
Citations look like this ~\cite{CitekeyInproceedings}.
...
\begin{figure}[htbp]
    % \centerline{\includegraphics[width=0.5\linewidth]{../Layout-dimensions.png}}
...
%with BibTex.bib%
% \bibliography{BibTex}        % Entries are in the BibTex.bib file
